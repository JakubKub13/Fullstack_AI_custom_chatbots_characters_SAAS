...
import { Category, Characters } from "@prisma/client";
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 pb-10">
          <div className="space-y-2 w-full col-span-2">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                General information about your characters
              </p>
            </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="col-span-2 md:col-span-1">
                  ...
                  <FormDescription>
                    This is how your AI Characters will be named.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Short description for your AI Characters
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Describe in detail your Characters&apos;s backstory and relevant details.
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Write couple of examples of a human chatting with your AI Characters, write expected answers.
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
          ...
          <div className="w-full flex justify-center">
            <Button size="lg" disabled={isLoading}>
              {initialData ? "Edit your Characters" : "Create your Characters"}
